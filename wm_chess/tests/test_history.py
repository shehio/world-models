...
def test_selfplay_with_history():
    ...
    Requires the selfplay experiment package to be importable.
    """
    try:
        from selfplay.selfplay import play_game  # type: ignore
    except ImportError:
        import pytest
        pytest.skip("selfplay experiment package not importable from wm_chess tests")
