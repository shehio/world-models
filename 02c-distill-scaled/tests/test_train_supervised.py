...
from azdistill_scaled.board import N_INPUT_PLANES, N_POLICY
from azdistill_scaled.config import Config
from azdistill_scaled.network import AlphaZeroNet
from azdistill_scaled.train_supervised import (
    MultipvDataset,
